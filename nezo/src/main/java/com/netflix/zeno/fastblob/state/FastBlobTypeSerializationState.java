 ...
 * its type and ordinals.  It performs this responsibility by using a {@link com.netflix.zeno.fastblob.state.ByteArrayOrdinalMap}.<p/>
 *
...
public class FastBlobTypeSerializationState<T> {
     ...
     *            {@link com.netflix.zeno.fastblob.FastBlobStateEngine}.
     */
     ...
     * @param numImages The number of blob images which will be produced by the {@link com.netflix.zeno.fastblob.FastBlobStateEngine}.
     */
     ...
     * representation in our {@link com.netflix.zeno.fastblob.state.ByteArrayOrdinalMap}
     * <p/>
     *
     ...
     * list returned by {@link com.netflix.zeno.fastblob.FastBlobStateEngine}.getImageConfigurations()
     *
     * @param data
     ...
     * assign or retrieve the ordinal for this serialized representation in our {@link com.netflix.zeno.fastblob.state.ByteArrayOrdinalMap}<p/>
     *
     ...
     * in which that image appears in the list returned by {@link com.netflix.zeno.fastblob.FastBlobStateEngine}.getImageConfigurations()
     *
     * @param data
     * @param imageMembershipsFlags
     */
