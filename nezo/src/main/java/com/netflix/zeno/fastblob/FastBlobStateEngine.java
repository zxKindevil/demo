 ...
 *
 * The blob is a serialized representation of all data conforming to an object model (defined by a {@link com.netflix.zeno.serializer.SerializerFactory})
 ...
 * serialized representations of Objects and "ordinals" (@see {@link com.netflix.zeno.fastblob.state.ByteArrayOrdinalMap}).<p/>
 *
...
public class FastBlobStateEngine extends SerializationFramework {
    ...
    /**
     * Add a {@link com.netflix.zeno.fastblob.state.TypeDeserializationStateListener} to the specified type
     */
