...
/**
 * This Object represents the result of a diff for a specific type in the {@link com.netflix.zeno.serializer.NFTypeSerializer} object hierarchy.
 *
 ...
 * - a list of {@link com.netflix.zeno.diff.TypeDiff.ObjectDiffScore}s, each of which contains a matching pair of Objects and the diff score between them.
 *
 * (from {@link com.netflix.zeno.diff.DiffRecord})
