...
/**
 * The DiffInstruction describes how to derive a {@link com.netflix.zeno.diff.DiffReport} on the deserialized Objects
 ...
 * specify a {@link com.netflix.zeno.diff.TypeDiffInstruction}.  Each TypeDiffInstruction informs how to match
 * up individual elements of that type.  Each pair of Objects will be examined for differences
 * throughout the hierarchy defined by the {@link com.netflix.zeno.serializer.NFTypeSerializer}s.
 *
 * @author dkoszewnik
 *
 */
public class DiffInstruction {
    ...
    /**
     * @deprecated instead use the interface provided by {@link com.netflix.zeno.diff.DiffOperation}
     */
    @Deprecated
