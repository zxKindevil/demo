...
/**
 * A diff record represents the combined values for all fields at all levels in an {@link com.netflix.zeno.serializer.NFTypeSerializer} hierarchy.
 *
 ...
 * allows us to not create new {@link com.netflix.zeno.diff.DiffPropertyPath} objects at each step during serialization.  The {@link com.netflix.zeno.diff.DiffRecordValueListMap} contains key/value
 * pairs.
 *
 * @author dkoszewnik
 *
