 ...
 * the zeno framework is a calculation of a hash of a given Object (see {@link com.netflix.zeno.hash.HashSerializationFramework}).  This is a one-way operation and therefore has no corresponding
 * "deserialization".  In this case, the {@link com.netflix.zeno.hash.HashFrameworkSerializer} does not have a corresponding deserializer.
 *
 * @author dkoszewnik
 *
 * @param <D>
