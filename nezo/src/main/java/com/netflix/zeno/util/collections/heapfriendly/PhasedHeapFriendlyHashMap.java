...
/**
 * Implementation of {@link java.util.Map} that wraps a {@link com.netflix.zeno.util.collections.heapfriendly.HeapFriendlyHashMap}
 * and exposes methods for switching in and out of a data swap phase. <p />
 * 
 * The data swap phase is entered by calling {@link com.netflix.zeno.util.collections.heapfriendly.PhasedHeapFriendlyHashMap#beginDataSwapPhase(int)} <p />
 * 
 * While in the data swap phase, {@link com.netflix.zeno.util.collections.heapfriendly.PhasedHeapFriendlyHashMap#put(Object, Object)}
 * can be used to fill the map with data. Data will not be available until the data swap phase is complete. <p />
 * 
 * Calling {@link com.netflix.zeno.util.collections.heapfriendly.PhasedHeapFriendlyHashMap#endDataSwapPhase()} will end the
...
public class PhasedHeapFriendlyHashMap<K, V> implements Map<K, V> {
     ...
     *
     * While in data swap phase, {@link com.netflix.zeno.util.collections.heapfriendly.PhasedHeapFriendlyHashMap#put(Object, Object)} can be used<p />
     *
     ...
     *
     * While out of the data swap phase, using {@link com.netflix.zeno.util.collections.heapfriendly.PhasedHeapFriendlyHashMap#put(Object, Object)}
