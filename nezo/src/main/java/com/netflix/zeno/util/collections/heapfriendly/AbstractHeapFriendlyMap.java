 ...
 *
 * @see com.netflix.zeno.util.collections.heapfriendly.HeapFriendlyMapArrayRecycler
 *
 * @author dkoszewnik
 *
 */
public abstract class AbstractHeapFriendlyMap<K, V> extends AbstractMap<K, V> {
    ...
    protected static abstract class AbstractHeapFriendlyMapEntry<K, V> implements Entry<K, V> {
        @Override
